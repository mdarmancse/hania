            ...
            <Grid container direction="row" spacing={2}>
                <Grid item xs style={{textAlign:isRTL==='rtl'?'right':'left'}}>
                    {settings.swipe_symbol===false?
                        <DashboardCard title={t('today_text')} image={require("../assets/img/moneylogo1.png").default}>{ settings.symbol + ' ' + dailygross}</DashboardCard>
                        :
                        <DashboardCard title={t('today_text')} image={require("../assets/img/moneylogo1.png").default}>{ dailygross + ' ' + settings.symbol }</DashboardCard>
                    }
                </Grid>
                <Grid item xs style={{textAlign:isRTL==='rtl'?'right':'left'}}>
                    {settings.swipe_symbol===false?
                        <DashboardCard title={t('this_month_text')} image={require("../assets/img/moneylogo1.png").default}>{ settings.symbol +' ' +  monthlygross}</DashboardCard>
                        :
                        <DashboardCard title={t('this_month_text')} image={require("../assets/img/moneylogo1.png").default}>{ monthlygross +' ' +  settings.symbol}</DashboardCard>
                    }
                </Grid>
                <Grid item xs style={{textAlign:isRTL==='rtl'?'right':'left'}}>
                    {settings.swipe_symbol===false?
                        <DashboardCard title={t('total')} image={require("../assets/img/moneylogo1.png").default}>{ settings.symbol +' ' +  totalgross}</DashboardCard>
                        :
                        <DashboardCard title={t('total')} image={require("../assets/img/moneylogo1.png").default}>{ totalgross +' ' +  settings.symbol}</DashboardCard>
                    }
                </Grid>
            </Grid>
            { mylocation?
