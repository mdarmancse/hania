...
export default function SelectGatewayPage(props) {
  ...
  const lCom = {icon:isRTL ? 'ios-arrow-forward':'ios-arrow-back', type: 'ionicon', color: colors.BLACK, size: 30, component: TouchableWithoutFeedback, onPress: () => { goBack() } }
  const rCom = { icon:isRTL ? 'ios-arrow-forward':'ios-arrow-back', type: 'ionicon', color: colors.BLACK, size: 30, component: TouchableWithoutFeedback, onPress: () => { goBack() } }
  return (
