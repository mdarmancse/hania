...
export default function OnlineChat(props) {
  ...
  const lCom = { icon: 'angle-left', type: 'font-awesome', color: colors.BLACK, size: 30, component: TouchableWithoutFeedback, onPress: () => { props.navigation.goBack(); } }
  const rCom = { icon: 'angle-right', type: 'font-awesome', color: colors.BLACK, size: 30, component: TouchableWithoutFeedback, onPress: () => { props.navigation.goBack(); } }
