...
import MapView, { PROVIDER_GOOGLE, Marker, UrlTile,AnimatedRegion } from 'react-native-maps';
...
export default function BookedCabScreen(props) {
                    ...
                    {role == 'driver' && ((curBooking.pickup_image && appcat=='delivery') || (!settings.AllowDeliveryPickupImageCapture && appcat=='delivery')  || appcat == 'taxi') && (curBooking.status == 'ACCEPTED' || curBooking.status == 'ARRIVED') ?
                        <View style={{ flex: 1 }}>
                            <Button
                                ...
                                buttonStyle={{ height: '100%', backgroundColor: colors.NEW }}
                                containerStyle={{ height: '100%' }}
                            />
                        </View>
                        : null}
                    ...
                    <View style={{ width: '80%', backgroundColor: colors.WHITE, borderRadius: 10, justifyContent: 'center', alignItems: 'center', flex: 1, maxHeight: 310,marginTop:15 }}>
                        ...
                        <View style={styles.buttonContainer}>
                            <Button
                                ...
                                buttonStyle={{width:100, backgroundColor: colors.BLACK}}
    ...
    const lCom = {icon:'arrow-back', type: 'ionicon', color: colors.BLACK, size: 30, component: TouchableWithoutFeedback, onPress: () => { goBack() } }
    const rCom = { icon:'ios-arrow-forward', type: 'ionicon', color: colors.BLACK, size: 30, component: TouchableWithoutFeedback, onPress: () => { goBack() } }
    return (
        <View style={styles.mainContainer}>
            ...
            <View style={styles.bottomContainer}>
                ...
                <View style={styles.cabDetailsContainer}>
                    ...
                    {curBooking && curBooking.status != "NEW" && role == 'rider' ?
                        <View style={styles.cabDetails}>
                            <View style={styles.vehicleDetails}>
                                <Text style={styles.vehicleDetails1}>{t('vehicle_details')}</Text>
                            </View>
                            <View style={styles.cabName}>
                                <Text style={styles.cabNameText}>{t('car_type')}</Text>
                                <Text style={styles.cabNameText1}>{curBooking.carType}</Text>
                            </View>

                            <View style={styles.cabMake}>
                                <Text style={styles.cabMake1}>{t('vmake')}</Text>
                                <Text style={styles.cabMake2}>{curBooking.vehicle_make}</Text>
                            </View>

                            <View style={styles.cabModel}>
                                <Text style={styles.cabModel1}>{t('vmodel')}</Text>
                                <Text style={styles.cabModel2}>{curBooking.vehicle_model}</Text>
                            </View>

                            <View style={styles.cabNumber}>
                                <Text style={styles.cabNumber1}>{t('vnumber')}</Text>
                                <Text style={styles.cabNumber2}>{curBooking.vehicle_number}</Text>
                            </View>

                            <View style={styles.cabColor}>
                                <Text style={styles.cabColor1}>{t('vcolor')}</Text>
                                <Text style={styles.cabColor2}>{curBooking.vehicle_color}</Text>
                            </View>
                        ...
                        <View style={styles.driverDetails}>
                                {role == 'rider' ?
                                   <View style={styles.driverPhotoContainer}>
                                    ...
                                    :
                                    <View style={styles.driverPhotoContainer1}>
                                    <Image source={curBooking.customer_image ? { uri: curBooking.customer_image } : require('../../assets/images/profilePic.png')} style={styles.driverPhoto1} />
                                    <Text style={styles.driverNameText1}>{curBooking.customer_name}</Text>
                                    </View>
                                }
                            <View style={styles.ratingContainer}>
                                {role == 'rider' ?
                                    <StarRating
                                        ...
                                        iconSet={'Ionicons'}
                                        fullStarColor={colors.NEW}
                                        emptyStarColor={colors.NEW}
                                        halfStarColor={colors.NEW}
...
const styles = StyleSheet.create({
    ...
    topContainer: { flex: 2.0,  borderTopWidth: 0, alignItems: 'center', backgroundColor: colors.WHITE, paddingEnd: 20, borderColor: colors.BLACK, borderWidth: 1 },
    topContainer1: { flex: 1.5,  borderTopWidth: 0, alignItems: 'center', backgroundColor: colors.WHITE, borderColor: colors.BLACK, borderWidth: 1, paddingEnd: 20 },
    topLeftContainer: {
        flex: 1.5,
        alignItems: 'center'
    },
    ...
    whereContainer1: { flex: 1, justifyContent: 'center', alignItems: 'center', },
    whereText: { flex: 9, fontFamily: 'Roboto-Regular', fontSize: 14, fontWeight: '400', color: colors.BLACK },
    whereText1: { flex: 9, fontFamily: 'Roboto-Regular', fontSize: 20, fontWeight: '400', marginLeft: 30, color: colors.BLACK },
    ...
    bottomContainer: { flex: 5.5, alignItems: 'center' },
    map: {
        flex: 1,
        ...StyleSheet.absoluteFillObject,
    },
    otpContainer: { flex: 0.4, backgroundColor: colors.BOX_BG, width: width, flexDirection: 'row', justifyContent: 'space-between' },
    ...
    otpText1: { alignSelf: 'center', color: colors.BLACK, fontSize: 36, fontFamily: 'Roboto-Bold' },
    cabDetailsContainer: { flex: 2.5, backgroundColor: colors.WHITE, flexDirection: 'row', position: 'relative', zIndex: 1 },
    cabDetails: { flex: 19 },
    cabName: { flex: 1, flexDirection: 'row', justifyContent: 'space-between', marginTop: 15, marginLeft: 10, },
    vehicleDetails: {flex: 1, marginTop: 40, alignSelf: 'center'},
    vehicleDetails1: {color: colors.BLACK, fontFamily: 'Roboto-Bold', fontSize: 12, bottom: 18, alignItems: 'center',},
    cabNameText: { color: colors.BLACK, fontFamily: 'Roboto-Bold', fontSize: 12, bottom: 18, alignItems: 'flex-start', },
    cabNameText1: { color: colors.BLACK, fontFamily: 'Roboto-Bold', fontSize: 12, bottom: 18, alignItems: 'flex-end', },
    cabMake: { flex: 1, flexDirection: 'row', justifyContent: 'space-between', marginTop: 15, marginLeft: 10, },
    cabMake1: { color: colors.BLACK, fontFamily: 'Roboto-Bold', fontSize: 12, bottom: 18, alignItems: 'flex-start', },
    cabMake2: { color: colors.BLACK, fontFamily: 'Roboto-Bold', fontSize: 12, bottom: 18, alignItems: 'flex-end', },
    cabModel: { flex: 1, flexDirection: 'row', justifyContent: 'space-between', marginLeft: 10, },
    cabModel1: { color: colors.BLACK, fontFamily: 'Roboto-Bold', fontSize: 12, bottom: 18, alignItems: 'flex-start', },
    cabModel2: { color: colors.BLACK, fontFamily: 'Roboto-Bold', fontSize: 12, bottom: 18, alignItems: 'flex-end', },
    cabNumber: { flex: 1, flexDirection: 'row', justifyContent: 'space-between', marginLeft: 10, },
    cabNumber1: { color: colors.BLACK, fontFamily: 'Roboto-Bold', fontSize: 12, bottom: 18, alignItems: 'flex-start', },
    cabNumber2: { color: colors.BLACK, fontFamily: 'Roboto-Bold', fontSize: 12, bottom: 18, alignItems: 'flex-end', },
    cabColor: { flex: 1, flexDirection: 'row', justifyContent: 'space-between', marginLeft: 10, },
    cabColor1: { color: colors.BLACK, fontFamily: 'Roboto-Bold', fontSize: 12, bottom: 18, alignItems: 'flex-start', },
    cabColor2: { color: colors.BLACK, fontFamily: 'Roboto-Bold', fontSize: 12, bottom: 18, alignItems: 'flex-end', },
    ...
    verticalLine: { height: height / 6, width: 0.5, backgroundColor: colors.BLACK, alignItems: 'center', marginTop: 10 },
    ...
    driverPhotoContainer1: { flex: 5.4, alignItems: 'flex-end', flexDirection: 'row' },
    driverPhoto: { borderRadius: height / 10 / 2, width: height / 10, height: height / 10 },
    driverPhoto1: { borderRadius: height / 8 / 2, width: height / 8, height: height / 8, right: 50, top: 20, },
    driverNameContainer: { flex: 2.2, alignItems: 'center', justifyContent: 'center' },
    driverNameText: { color: '#000000', fontFamily: 'Roboto-Bold', fontSize: 14 },
    driverNameText1: { color: '#000000', fontFamily: 'Roboto-Bold', fontSize: 18, bottom: 16, },
    ...
    cancelReasonText: { top: 10, color: colors.BLACK, fontFamily: 'Roboto-Bold', fontSize: 16, alignSelf: 'center' },
    radioContainer: { flex: 8, alignItems: 'center' },
    radioText: { fontSize: 12, fontFamily: 'Roboto-Medium', color: colors.BLACK, },
