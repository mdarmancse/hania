...
import BookingLater from "../screens/BookingLater";
        ...
        return (
            ...
            >
                {auth.info && auth.info.profile && auth.info.profile.usertype == 'rider' ?
                    ...
                    : null}
                {auth.info && auth.info.profile && auth.info.profile.usertype == 'rider' ?
                    <Drawer.Screen name="Map2" component={MapScreen2} />
                    : null}
                {auth.info && auth.info.profile && auth.info.profile.usertype == 'rider' ?
                    <Drawer.Screen name="Map3" component={MapScreen3} />
                    : null}
                {auth.info && auth.info.profile && auth.info.profile.usertype == 'rider' ?
                ...
                <Drawer.Screen name="BookingLater" component={BookingLater} />
            ...
            //je doit ajouter reservation plus tard
        );
    }
